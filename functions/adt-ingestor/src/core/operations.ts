...
export type DeleteTwinOp = { type: 'DeleteTwin'; twinId: string };
export type DeleteModelOp = { type: 'DeleteModel'; modelId: string };

export type AdtOperation = EnsureModelsOp | UpsertTwinOp | UpsertRelationshipOp | PatchTwinOp | DeleteTwinOp | DeleteModelOp;
